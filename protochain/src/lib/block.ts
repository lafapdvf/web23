...
export default class Block {
  ...
  /**
   * Generates a new valid hash for this block with the given difficulty
   * @param difficulty The blockchain current mining difficulty
    ...
    if (this.transactions && this.transactions.length) {
      ...
      if (errors.length > 0)
        return new Validation(
          false,
          "Invalid tx(s) found within the block: " +
